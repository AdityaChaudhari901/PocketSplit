...
export const LanguageScreen = () => {
  ...
  return (
    <Screen contentStyle={styles.screenContent}>
      ...
      <TextField label={t("common.search")} value={query} onChangeText={setQuery} placeholder={t("language.searchPlaceholder")} leftIcon="search" />
        ...
        {visibleLanguages.map((language) => {
          ...
          return (
            ...
            >
              ...
              {selected ? <StatusBadge label={t("common.selected")} tone="ai" /> : <Ionicons name="chevron-forward" size={18} color={theme.colors.subtext} />}
            </Pressable>
          );
        })}
      </View>
